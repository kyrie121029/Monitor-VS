<template>
  ...
  div {
    ...
    align-items: center;
    color: black; /* 修改div内文本颜色为黑色 */
  }
  
  label {
    margin-right: 10px;
    color: black; /* 修改标签颜色为黑色 */
  }
  ...
  .info-container {
    ...
    border-radius: 4px;
    width: 400px;
    color: black; /* 修改信息容器文本颜色为黑色 */
  }
  
  ul {
    list-style-type: none;
    padding: 0;
    color: black; /* 修改ul内文本颜色为黑色 */
  }
  ...
  li {
    ...
    padding: 10px;
    border-radius: 4px;
    color: black; /* 修改li内文本颜色为黑色 */
  }
  
  .vue-datepicker-local__content {
    color: black; /* 修改日历内文本颜色为黑色 */
  }
  </style>
